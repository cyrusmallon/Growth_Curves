...
data_new <-
  full_join(data_ansc_new, data_evld_new, by = c("ID", "species", "tech_replicate", "time_hrs", "OD600", "carbon_source","species_richness","community", "bio_replicate"))
